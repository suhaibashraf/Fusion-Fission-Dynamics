...
to go
  ...
  lt search-angle
    ...
    [ ask patches in-cone visiond visionAng [set pcolor white - 5]]
    []
...
;      lt search-angle
      ...
      [
       ...
       ifelse distance nearest-neighbor < near-view
      [ set color orange
       rt 20
       lt 20
        fd 1
        ...
        [
              ifelse distance nearest-neighbor < max-view
      [
...
to find-flockmates
  set flockmates other turtles in-cone max-view visionAng
end
